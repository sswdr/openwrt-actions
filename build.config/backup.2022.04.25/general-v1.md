基于min-v1.config, 在backup.2022.04.25_build.2022.04.25.18.00下执行make menuconfig进行如下操作: 
...
general-v1.config = 5.10-lede+kenzok8-max-v3.config 在 backup.2022.04.25_build.2022.04.25.18.00 下执行 make defconfig

general-v1.config = https://github.com/sswdr/openwrt-actions/releases/download/backup.2022.04.25_build.2022.04.25.18.00/workdir.tar.gz
